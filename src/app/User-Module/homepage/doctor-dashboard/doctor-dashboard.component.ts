...
export class DoctorDashboardComponent {
  ...
  //   const doctorProfile = this.doctorService.getDoctorProfileByLoginId(this.loginId);
  //   this.doctorProfile = await firstValueFrom(doctorProfile);
  //   this.sharedService.saveId(this.doctorProfile.doctorID);
  // }
  ...
  async GetDoctorId() {
    return new Promise<void>((resolve, reject) => {
      ...
      this.doctorService.getDoctorProfileByLoginId(this.loginId).subscribe((res: any) => {
        ...
        this.sharedService.saveId(this.doctorProfile.doctorID);
        resolve(); // Resolve the promise when the doctor ID is fetched and saved
      }, error => {
  ...
  async ngOnInit(): Promise<void> {
    try {
      ...
      // Now you can safely access this.doctorProfile.doctorID here
  ...
  // getDoctorAppointmentsByDoctorId(profile: any) {
  //   this.ngxLoader.start();
  //   this.doctorId = profile.doctorID
  //   this.doctorService.getDoctorAppointmentsWithDoctorId(this.doctorId, this.currentpageIndex, this.currentpageSize, this.filterValue, this.sortColumnName, this.sortOrder).subscribe({
  //     next: (res: any) => {
  //       this.totalData = res.totalResultedRecords;
  //       this.dataList = res.data;
  //       this.ngxLoader.stop();
  ...
  //   this.getDoctorAppointmentsByDoctorId(this.doctorProfile);
  // }
  ...
  //       this.ngOnInit();
  //       setTimeout(() => {
  //         this.getDoctorAppointmentsByDoctorId(this.loginId);
  //         // this.getAllAppointmentsList();
  //       }, 2000);
  //     },
  //     error: (error: any) => {
